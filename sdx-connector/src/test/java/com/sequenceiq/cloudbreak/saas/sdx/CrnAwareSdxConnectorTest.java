...
public class CrnAwareSdxConnectorTest {
    ...
    public void testList() {
        ...
        assertTrue(underTest.listSdxCrns("env", "envCrn", TargetPlatform.PAAS).containsAll(Set.of(PAAS_CRN)));
        assertTrue(underTest.listSdxCrns("env", "envCrn", TargetPlatform.SAAS).containsAll(Set.of(SAAS_CRN)));
    }
    ...
    public void testBothGetAttemptResult() {
        assertThrows(IllegalStateException.class, () ->
                underTest.getAttemptResultForDeletion(Set.of(PAAS_CRN, SAAS_CRN), "env", "envCrn"));
